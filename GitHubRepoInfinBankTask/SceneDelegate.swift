...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        self.window?.rootViewController = UINavigationController(rootViewController: setRootViewController())
    ...
    private func setRootViewController() -> UIViewController {
        ...
        let reposVC = ReposViewController(viewModel: ReposViewModel(service: service))
        return UD.access_token == nil ? initialVC : reposVC
    }
